...
public interface DFLiteVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code argumentBri}
	 * labeled alternative in {@link DFLiteParser#argument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgumentBri(DFLiteParser.ArgumentBriContext ctx);
	/**
	 * Visit a parse tree produced by the {@code argumentSta}
	 * labeled alternative in {@link DFLiteParser#argument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgumentSta(DFLiteParser.ArgumentStaContext ctx);
}