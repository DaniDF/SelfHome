...
public class Symmetric {
    ...
    private static byte[] createInitializationVector(@IntRange(from = 1, to = Long.MAX_VALUE) int dim)
    {
    ...
    public static @NotNull Key createAESKey(@IntRange(from = 1, to = Long.MAX_VALUE) int dim)
    {
